...
export const PAGE = "mx-auto flex w-full max-w-md flex-1 flex-col gap-4 px-5 pt-3 pb-8";
export const ROW =
...
export function PickerFrame({
  ...
  return (
    <main data-type={type} className={PAGE}>
      <Link href={backHref} className="-mb-2 inline-flex min-h-11 items-center gap-1.5 font-mono text-[10px] tracking-[0.08em] text-dim uppercase">
