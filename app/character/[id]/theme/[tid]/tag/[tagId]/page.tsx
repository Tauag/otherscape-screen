  ...
  return (
    ...
    >
      <p className="font-sans text-sm text-dim">
        Questions from {book || "no themebook yet"}. Every one stays on offer, so a question may
              ...
              <span className="flex items-baseline gap-2">
                ...
                {row.count > 0 && (
                  <span className={LABEL}>
                    Already answered by {row.count} {row.count === 1 ? "tag" : "tags"}
                  </span>
                )}
              </span>
      ...
      {power && (
        <section className="flex flex-col gap-2">
          ...
          <p className="font-sans text-sm text-dim">
            A theme special can send this tag to another themebook. Pick one and its questions
