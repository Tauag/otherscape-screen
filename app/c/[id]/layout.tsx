...
import { CharacterProvider } from "@/app/c/[id]/provider";
import { migrate } from "@/lib/character/migrate";
import { createClient } from "@/lib/supabase/server";

// The one read of the document. Tabs under /c/[id] are routes inside this
// layout, so switching them refetches nothing.
export default async function CharacterLayout({ children, params }: LayoutProps<"/c/[id]">) {
