...
export const sample: Character = {
  ...
  veteranSpecials: ["Nobody Stays Bought — spend 1 Power to learn who paid for the job."],
  evolutions: {
  ...
  themes: [
    {
      ...
      powerTags: [
        ...
        { id: "pt-2", themebook: "Troubled Past", letter: "C", text: "old badge number", burnt: false },
        { id: "pt-3", themebook: "Troubled Past", letter: "C", text: "a favour owed by a desk sergeant", burnt: true },
      ],
      weaknessTags: [{ id: "wt-1", letter: "B", text: "nobody at the precinct returns my calls" }],
    ...
    },
    {
      ...
      powerTags: [
        ...
        { id: "pt-5", themebook: "Artifact", letter: "D", text: "burns on borrowed memory", burnt: false },
        { id: "pt-6", themebook: "Esoterica", letter: "F", text: "reads the residue of a death", burnt: false },
      ],
      weaknessTags: [{ id: "wt-2", letter: "A", text: "the lantern wants to be carried home" }],
      quote: "Light it only for the dead who ask.",
      specials: ["Borrowed Rites — a power tag here may answer a question from any Mythos themebook."],
      upgrade: 0,
      decay: 3,
    },
    {
      ...
      powerTags: [
        ...
        { id: "pt-8", themebook: "Augmentation", letter: "B", text: "subdermal armour weave", burnt: false },
      ],
      weaknessTags: [{ id: "wt-3", letter: "C", text: "the chrome hums when I lie" }],
  ...
  ghostMemories: [
    {
      ...
      reason: "Decay filled the week she burned the case file. She let the expertise go with it.",
      theme: {
        id: "th-forensics",
        type: "self",
        themebook: "Expertise",
        powerTags: [
          ...
          { id: "pt-g2", themebook: "Expertise", letter: "E", text: "reads a wound like a sentence", burnt: true },
        ],
        weaknessTags: [{ id: "wt-g1", letter: "D", text: "I need to be the one who is certain" }],
  ...
  statuses: [
    { id: "st-1", name: "exhausted", valence: "negative", tiers: [false, true, false, true, false, false], owner: "mine", out: false },
    { id: "st-2", name: "amped-up", valence: "positive", tiers: [false, false, true, false, false, false], owner: "mine", out: false },
    { id: "st-3", name: "hunted-by-the-syndicate", valence: "negative", tiers: [false, false, false, false, false, true], owner: "mc", out: false },
  ],
  storyTags: [
    { id: "sg-1", name: "rain-slicked rooftops", valence: "positive", scratched: false },
    { id: "sg-2", name: "the alarm is live", valence: "negative", scratched: true },
  ],
  creationStep: null,
};
